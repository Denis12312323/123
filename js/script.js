...
// Подсвечивание текущей  Странички
...
navLinks.forEach(link => {
    ...
    } else if (pathname == "/regions/kharkiv.html" || pathname == "/regions/kyiv.html" || pathname == "/regions/cherkasy.html" || pathname == "/regions/chernihiv.html" || pathname == "/regions/chernivtsi.html" || pathname == "/regions/crimea.html" || pathname == "/regions/dnipro.html" || pathname == "/regions/donetsk.html" || pathname == "/regions/ivano-frankivsk.html" || pathname == "/regions/kherson.html" || pathname == "/regions/khmelnytskyi.html" || pathname == "/regions/kropyvnytskyi.html" || pathname == "/regions/lutsk.html" || pathname == "/regions/lviv.html" || pathname == "/regions/mykolaiv.html" || pathname == "/regions/odesa.html" || pathname == "/regions/poltava.html" || pathname == "/regions/rivne.html" || pathname == "/regions/sumy.html" || pathname == "/regions/ternopil.html" || pathname == "/regions/uzhhorod.html" || pathname == "/regions/vinnitsa.html" || pathname == "/regions/zaporizhzhia.html" || pathname == "/regions/zhytomyr.html") {
        navLinks[1].classList.add("current");
    }
});

let watchVideoBtn = document.querySelector('.media__button');
